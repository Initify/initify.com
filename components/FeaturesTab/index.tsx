      ...
      <section className="relative pb-20 pt-18.5 lg:pb-22.5">
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="animate_top shadow-initify-5 dark:shadow-initify-6 mb-15 flex flex-wrap justify-center rounded-[10px] border border-stroke bg-white dark:border-strokedark dark:bg-blacksection md:flex-nowrap md:items-center lg:gap-7.5 xl:mb-21.5 xl:gap-12.5"
          >
            <div
