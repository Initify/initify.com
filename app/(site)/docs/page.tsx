...
export const metadata: Metadata = {
  title: "Docs Page - initify SaaS Boilerplate",

  // other metadata
  description: "This is Docs page for initify Pro",
};
        ...
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-1/4">
              <div className="shadow-initify-4 sticky top-[74px] rounded-lg border border-white p-4  transition-all  dark:border-strokedark dark:bg-blacksection">
